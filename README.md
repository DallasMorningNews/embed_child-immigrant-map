...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2018/embed-child-immigrant-map/` folder on our interactives S3 bucket.
...
```html
<div id="embed-embed-child-immigrant-map"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-embed-child-immigrant-map', '//interactives.dallasnews.com/embeds/2018/embed-child-immigrant-map/', {})</script>
```
